  ...
  return (
    <div className="flex items-center justify-center min-h-[80vh] px-4 py-8">
      <div className="w-full max-w-md p-8 sm:p-10 rounded-3xl bg-white/90 backdrop-blur-xl border border-white/60 shadow-2xl shadow-blue-900/10">
        ...
        {/* Google Personalized Sign-In Button */}
        <div className="flex flex-col items-center justify-center w-full">
          <div className="rounded-full overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-200 flex items-center justify-center bg-[#1a73e8]">
            <GoogleLogin
